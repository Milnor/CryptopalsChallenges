...
int main()
{
    ...
    uint8_t pad1_input[] = "6c6967687420776f726b2e"; // "light work." 
    uint8_t pad1_output[] = "bGlnaHQgd29yay4=";
    output = hex_to_base64(pad1_input);
    ...
    uint8_t pad2_input[] = "6c6967687420776f726b"; // "light work" 
    uint8_t pad2_output[] = "bGlnaHQgd29yaw==";
    output = hex_to_base64(pad2_input);
